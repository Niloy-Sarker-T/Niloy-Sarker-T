...
Computer Science & Engineering student at SUST (CGPA: 3.54), focused on building **production-grade AI systems** across LLMs, Computer Vision, and Speech AI.

Former President & R&D Secretary of RoboSUST (3 years), leading technical teams and research initiatives.
...
- 🏥 Finalist – Harvard HSIL Hackathon 2026 (SignMedix AI: MediaPipe + Transformer)

---

## 📖 Research

- 📄 **First-author paper (IEEE COMPAS 2025)**  
  *Bangla Speech to IPA Transcription using Multi-Stage Transformer*

- 🔬 Ongoing Thesis:
  - Bangla Sign Language Recognition (video → gloss generation)
  - Bangla tabular OCR for structured document reconstruction
...
Python • FastAPI • PyTorch • OpenCV • Qdrant • PostgreSQL • React • MongoDB • NLP • LLMs
